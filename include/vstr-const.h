...
/* #define VSTR_CNTL_CONF_GET_NUM_SPARE_BUF VSTR__CNTL(CONF, 37) */
#define VSTR_CNTL_CONF_SET_NUM_RANGE_SPARE_BUF VSTR__CNTL(CONF, 38)
/* #define VSTR_CNTL_CONF_GET_NUM_SPARE_NON VSTR__CNTL(CONF, 39) */
#define VSTR_CNTL_CONF_SET_NUM_RANGE_SPARE_NON VSTR__CNTL(CONF, 40)
/* #define VSTR_CNTL_CONF_GET_NUM_SPARE_PTR VSTR__CNTL(CONF, 41) */
#define VSTR_CNTL_CONF_SET_NUM_RANGE_SPARE_PTR VSTR__CNTL(CONF, 42)
/* #define VSTR_CNTL_CONF_GET_NUM_SPARE_REF VSTR__CNTL(CONF, 43) */
