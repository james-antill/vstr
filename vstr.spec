...
%changelog
* Mon Jan 13 2003 James Antill <james@and.org> 0.9.21-%{real_release_num}
- Moved the includedir to /usr/include/vstr-*
...
%configure --prefix=%{prefix} \
  ...
  --libdir=%{_libdir} --includedir=%{_includedir}/vstr-%{libver} \
