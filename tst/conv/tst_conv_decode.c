...
int tst(void)
{
  ...
  VSTR_ADD_CSTR_BUF(s2, s2->len, "abcd%20xyz%0AX");
  VSTR_ADD_CSTR_PTR(s2, s2->len, "abcd%20xyz%0aX");

  VSTR_ADD_CSTR_BUF(s3, s3->len, "abcd%20xyz%0AX");
  VSTR_ADD_CSTR_PTR(s3, s3->len, "abcd%20xyz%0aX");
