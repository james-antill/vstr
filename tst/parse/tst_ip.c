...
int tst(void)
{
  ...
  TST_IP(VSTR_FLAG_PARSE_IPV4_CIDR | VSTR_FLAG_PARSE_IPV4_CIDR_FULL,
         127, 0, 0, 1, 8, strlen("127.0.0.1/8"), 0);
  TST_IP(VSTR_FLAG_PARSE_IPV4_CIDR | VSTR_FLAG_PARSE_IPV4_NETMASK,
         127, 0, 0, 1, 8, strlen("127.0.0.1/8"), 0);
  ...
  TST_IP(VSTR_FLAG_PARSE_IPV4_NETMASK | VSTR_FLAG_PARSE_IPV4_NETMASK_FULL,
         127, 0, 0, 1, 17, strlen("127.0.0.1/255.255.128.0"), 0);
  TST_IP(VSTR_FLAG_PARSE_IPV4_CIDR | VSTR_FLAG_PARSE_IPV4_NETMASK,
         127, 0, 0, 1, 17, strlen("127.0.0.1/255.255.128.0"), 0);
